package net.lavder.blafecho.world;
...
public class ModConfiguredFeatures {
    // CF (what structures) -> PF (how placing) -> WG (where biome placing)
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> context) {
        //do we have certain block to replace it with ore
        ...
        List<OreFeatureConfig.Target> netherPinkGarnetOres =
                List.of(OreFeatureConfig.createTarget(netherReplaceables, ModBlocks.PINK_GARNET_ORE.getDefaultState()));
        List<OreFeatureConfig.Target> endPinkGarnetOres =
                List.of(OreFeatureConfig.createTarget(endReplaceables, ModBlocks.PINK_GARNET_NETHER_ORE.getDefaultState()));

        register(context, PINK_GARNET_ORE_KEY, Feature.ORE, new OreFeatureConfig(overworldPinkGarnetOres, 12)); // vein size
    ...
    public static RegistryKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier.of(BlafEcho.MOD_ID, name));
    }
