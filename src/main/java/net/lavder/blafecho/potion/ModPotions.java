package net.lavder.blafecho.potion;
...
public class ModPotions {
    ...
    private static RegistryEntry<Potion> registerPotion(String name, Potion potion) {
        return Registry.registerReference(Registries.POTION, Identifier.of(BlafEcho.MOD_ID, name), potion);
    }

    public static void registerPotions() {
        BlafEcho.LOGGER.info("Registering Potions for " + BlafEcho.MOD_ID);
    }
}
