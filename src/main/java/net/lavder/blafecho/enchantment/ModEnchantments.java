...
public class ModEnchantments {
    public static final RegistryKey<Enchantment> LIGHTNING_STRIKER =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(BlafEcho.MOD_ID, "lighting_striker"));
    ...
    public static void bootstrap(Registerable<Enchantment> registerable) {
        ...
        register(registerable, LIGHTNING_STRIKER, Enchantment.builder(Enchantment.definition(
                ...
                .addEffect(EnchantmentEffectComponentTypes.POST_ATTACK,
                        ...
                        new LightningStrikerEnchantmentEffect())); // some enchantment incompatibility
    }
