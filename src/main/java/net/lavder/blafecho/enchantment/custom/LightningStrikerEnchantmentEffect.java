package net.lavder.blafecho.enchantment.custom;
...
public record LightningStrikerEnchantmentEffect() implements EnchantmentEntityEffect {
    ...
    @Override
    public void apply(ServerWorld world, int level, EnchantmentEffectContext context, Entity user, Vec3d pos) { // what to do on apply
        if (level == 1) {
