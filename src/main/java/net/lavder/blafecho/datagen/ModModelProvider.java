...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        // itemModelGenerator.register(ModItems.CHISEL, Models.GENERATED); // custom model
        ...
        itemModelGenerator.registerArmor(((ArmorItem) ModItems.PINK_GARNET_HELMET)); // armorItem -> trimmable
