...
public class MantisModel<T extends MantisEntity> extends SinglePartEntityModel<T> { // almost all of this crazy shi below was exported from blockbench, don't worry
    public static final EntityModelLayer MANTIS = new EntityModelLayer(Identifier.of(BlafEcho.MOD_ID, "mantis"), "main"); // write this
    private final ModelPart root;
    private final ModelPart mantis;
    private final ModelPart head;

    public MantisModel(ModelPart root) { // rename this
    ...
    public void setAngles(MantisEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.getPart().traverse().forEach(ModelPart::resetTransform); // SUPER IMPORTANT, to reset anims
    ...
    private void setHeadAngles(float headYaw, float headPitch) { // copied this
    ...
    @Override
    public ModelPart getPart() { // write this
        return root;
    }
}
// u can see CamelEntity for good example
